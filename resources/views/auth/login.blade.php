...
<div class="col-md-14">
  ...
  <div class="form-group form-check">
    ...
    id="exampleCheck1" name="remember" id="remember" {{ old('remember') ? 'checked' : '' }} />
    <label class="form-check-label" for="remember">{{ __('Remember Me') }}</label>
  </div>

  <button type="submit" class="btn btn-login btn-block btn-primary"> {{ __('Sign In') }}</button>
    ...
    <script src="frontend/libraries/jquery/jquery-3.5.1.js"></script>
